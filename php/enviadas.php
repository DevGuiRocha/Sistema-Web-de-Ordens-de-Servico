...
?>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>N° da C.I.</th><th>Data</th><th>Para</th><th>Setor</th><th>Status</th><th>Ação</th>";
        ...
        while($row = $result->fetch_assoc()) {
		  ...
		  <td><a style="
    color: black; text-decoration:none;" href="visualizar.php?id=<?php echo $row ['ID']; ?>">(Clique para ver a C.I.)</a></td>
